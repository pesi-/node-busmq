...
var _writeCommands = [
  ...
  'rpop', 'lpop', 'lrange', 'ltrim', 'incr', 'decr', 'persist', 'expire', 'hgetall', 'hdel',
  'hlen', 'hkeys', 'hvals', 'hmset', 'hget', 'hmget', 'hset', 'hsetnx', 'hdel', 'hgetall',
  'publish', 'eval', 'evalsha', 'multi', 'exec', 'script', 'send_command'];
...
Connection.prototype._setupListeners = function(client, type, cb) {
  ...
  client.stream && client.stream.on('drain', _onClientDrain);
};
